...
COPY phpmyadmin/apache.allgranted.conf ${X_TMP}/apache.allgranted.conf
...
RUN apt-get update -q \
    ...
    && ln -s /etc/phpmyadmin/apache.allgranted.conf /etc/apache2/conf-enabled/phpadmin.allgranted.conf \
